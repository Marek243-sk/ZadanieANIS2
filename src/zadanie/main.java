...
public class main {
    public static void main(String[] args) {
        ...
        /*try {
            ...
            manazer.pridelenieUbytovania("Hotel Dukla", "Námestie legionárov", 52, "1", 1, 9);
...
/*
        ...
        try {
            Atrakcia atrakcia1 = new LetnaAtrakcia("Kúpalisko","leto",20);
            Atrakcia atrakcia2 = new ZimnaAtrakcia("Tatry", "zima",15);
            Atrakcia atrakcia3 = new LetnaAtrakcia("Bobová dráha", "leto",800);
            Atrakcia atrakcia4 = new ZimnaAtrakcia("Tatry", "zima", 50);
            ...
            zoznamAtrakcii.pridajAtrakciu(atrakcia4);
            zoznamAtrakcii.infoOAtrakciach();
